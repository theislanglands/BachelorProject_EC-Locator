...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    tabs: import("vue").ComputedRef<{
        ...
        disabled: boolean;
        navItemClasses: any[];
        tabClasses: (ClassValue | null)[];
        target: string;
        title: any;
        titleItemClass: any;
        titleLinkAttributes: any;
        onClick: any;
        tab: import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }>;
        tabComponent: () => import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }>;
    }[]>;
